...
import dev.aurakai.auraframefx.core.UIDesign
...
import dev.aurakai.auraframefx.core.viewmodels.CollaborativeWorkspaceViewModel

/**
 * Ã°Å¸Å½Â¨ COLLAB CANVAS SCREEN
...
fun CollabCanvasScreen(
    onNavigateBack: () -> Unit,
    viewModel: CollaborativeWorkspaceViewModel = androidx.hilt.lifecycle.viewmodel.compose.hiltViewModel()
) {
