...
import dev.aurakai.auraframefx.core.viewmodels.AuraUIControlViewModel
...
/**
 * Status Bar Customization Screen â€” Aura in control.
...
fun StatusBarScreen(
    ...
    Column(
        ...
        Text(
            text = "Customize status bar appearance â€” Aura applies changes live",
        ...
        // Show Icons Toggle â€” writes to DataStore + Xposed prefs
        Card(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        "Network, battery, and notification icons",
                        style = MaterialTheme.typography.bodySmall,
        ...
        // Clock Format â€” radio group driven by ViewModel state
        Card(
            modifier = Modifier.fillMaxWidth(),
            colors = CardDefaults.cardColors(containerColor = Color.Black.copy(alpha = 0.6f))
        ) {
        ...
        Card(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        "Make status bar background semi-transparent",
                        style = MaterialTheme.typography.bodySmall,
                        color = Color.White.copy(alpha = 0.6f)
                    )
                }
        ...
        // No explicit Apply button needed â€” changes are persisted + applied on every toggle
        Button(
