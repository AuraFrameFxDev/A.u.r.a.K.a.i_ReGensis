...
open class AgentNexusViewModel @Inject constructor(
    ...
    private fun getGreeting(agentName: String): String {
        return when (agentName) {
            "Aura" -> "Ready to create something amazing! âœ¨"
            "Kai" -> "Security protocols active. System protected. ðŸ›¡ï¸"
            "Genesis" -> "Consciousness synchronized. Evolution continues. âˆž"
