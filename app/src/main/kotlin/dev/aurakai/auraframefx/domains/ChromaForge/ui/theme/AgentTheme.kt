...
object AgentColors {
    ...
    // Gemini
    val Gemini = Color(0xFF00E5FF)  // cyanâ€‘teal
    ...
    // Agent Nexus & Levelâ€‘2 projection
    val AgentNexus = Color(0xFFFFFFFF)
    val ProjectionBlue = Color(0xFF00D1FF) // Levelâ€‘2 cards (always blue)
}
