...
import dev.aurakai.auraframefx.core.core.ApplyIconPackTool
import dev.aurakai.auraframefx.core.core.ApplyThemeTool
import dev.aurakai.auraframefx.core.core.CustomizeStatusBarTool
import dev.aurakai.auraframefx.core.core.GenerateUIComponentTool
...
class ToolInitializer @Inject constructor(
    ...
    /**
     * Registers and configures MCP APIâ€“backed tools into the tool registry.
     *
        ...
        val summary = buildString {
            ...
            toolsByCategory.forEach { (category, tools) ->
                ...
                tools.forEach { tool ->
                    ...
                    appendLine("  â€¢ ${tool.name} (agents: $agents)")
                }
                appendLine()
            }
        }
