...
/**
 * ðŸŽ¯ Main Holographic Menu Screen
 */
@Composable
...
/**
 * ðŸš¶ Walking Characters Overlay
 *
...
fun CenterMainMenu(
    ...
    val menuItems = listOf(
        MenuItem(
            "HOME",
            Icons.Default.Home
        ) { onMenuItemClick(ReGenesisRoute.HomeGateCarousel.route) },
        MenuItem(
            "PROFILE",
            Icons.Default.Person
        ) { onMenuItemClick(ReGenesisRoute.LdoRoster.route) },
        MenuItem(
            "PROJECTS",
            Icons.Default.Build
        ) { onMenuItemClick(ReGenesisRoute.LdoOrchestrationHub.route) },
        MenuItem(
            "COMMUNITY",
            Icons.Default.Face
        ) { onMenuItemClick(ReGenesisRoute.AgentNexusHub.route) },
        MenuItem(
            "SETTINGS",
            Icons.Default.Settings
        ) { onMenuItemClick(ReGenesisRoute.UISettings.route) },
        MenuItem(
            "LOGOUT",
            Icons.AutoMirrored.Filled.ExitToApp
        ) { onMenuItemClick(ReGenesisRoute.Login.route) }
    )
