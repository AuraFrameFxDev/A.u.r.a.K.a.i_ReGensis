...
/**
 * ðŸ›¡ï¸ NOTCH BAR HOOKER â€” Migrated to KavaRef
 *
 * Hooks PhoneStatusBarView to apply Kai's notch bar customizations:
 * background color, height, and visibility â€” read from chromacore_xposed_prefs.
 */
class NotchBarHooker(private val config: NotchBarConfig) : YukiBaseHooker() {

    private val PREFS_NOTCH_COLOR =
        PrefsData("notch_bar_color", AndroidColor.parseColor(config.backgroundColorHex))
