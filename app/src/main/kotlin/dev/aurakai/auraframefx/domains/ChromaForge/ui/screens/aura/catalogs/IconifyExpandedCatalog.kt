/**
 * ðŸŽ¨ ICONIFY SETTINGS CATALOG - FULL EXPANSION
 *
...
package dev.aurakai.auraframefx.core.ui.screens.aura.catalogs
...
object IconifyExpandedCatalog {
    ...
    val batteryStyles = listOf(
        ...
        IconifySetting(
            "battery_style_landscape_ios_15",
            "Landscape iOS 15",
            "Wide iOS 15 battery",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_ios_16_plus",
            "Landscape iOS 16+",
            "Enhanced wide battery",
            SettingType.SELECTION,
            false,
            xpReward = 15
        ),
        IconifySetting(
            "battery_style_landscape_battery_a",
            "Landscape Battery A",
            "Custom variant A",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_b",
            "Landscape Battery B",
            "Custom variant B",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_c",
            "Landscape Battery C",
            "Custom variant C",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_d",
            "Landscape Battery D",
            "Custom variant D",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_e",
            "Landscape Battery E",
            "Custom variant E",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_f",
            "Landscape Battery F",
            "Custom variant F",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_g",
            "Landscape Battery G",
            "Custom variant G",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_k",
            "Landscape Battery K",
            "Custom variant K",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_n",
            "Landscape Battery N",
            "Custom variant N",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_battery_o",
            "Landscape Battery O",
            "Custom variant O",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_colorful",
            "Landscape Colorful",
            "Gradient battery",
            SettingType.SELECTION,
            false,
        ...
        IconifySetting(
            "battery_style_landscape_oos",
            "Landscape OOS",
            "OnePlus OxygenOS style",
            SettingType.SELECTION,
            false,
            xpReward = 15
        ),
        ...
        IconifySetting(
            "battery_rotation",
            "Battery Icon Rotation",
            "Rotate battery icon degrees",
            SettingType.SLIDER,
            false,
            xpReward = 10
        ),
        ...
        IconifySetting(
            "battery_scale_height",
            "Battery Height Scale",
            "Adjust icon height",
            SettingType.SLIDER,
            false,
            xpReward = 5
        ...
        IconifySetting(
            "battery_margin_left",
            "Battery Margin Left",
            "Left spacing adjustment",
            SettingType.SLIDER,
            false,
            xpReward = 5
        ),
        IconifySetting(
            "battery_margin_right",
            "Battery Margin Right",
            "Right spacing adjustment",
            SettingType.SLIDER,
            false,
            xpReward = 5
        )
    ...
    val statusBarSettings = listOf(
        ...
        IconifySetting(
            "statusbar_clock_size",
            "Clock Text Size",
            "Adjust clock font size",
            SettingType.SLIDER,
            false,
            xpReward = 10
        ),
        ...
        IconifySetting(
            "statusbar_network_traffic_interval",
        ...
        IconifySetting(
            "statusbar_network_traffic_color_upload",
            "Upload Color",
            "Upload speed color",
            SettingType.COLOR_PICKER,
            false,
        ...
        IconifySetting(
            "statusbar_network_traffic_color_download",
            "Download Color",
        ...
        IconifySetting(
            "statusbar_wifi_icon",
            "WiFi Icon Style",
            "Customize WiFi indicator",
            SettingType.SELECTION,
            false,
            xpReward = 10
        ),
        IconifySetting(
            "statusbar_data_disabled_icon",
            "Data Disabled Icon",
            "Custom no-data indicator",
            SettingType.TOGGLE,
            false,
            xpReward = 10
        ),
        IconifySetting(
            "statusbar_nfc_icon",
            "NFC Icon Visibility",
            "Show/hide NFC indicator",
            SettingType.TOGGLE,
            false,
            xpReward = 5
        ),
        IconifySetting(
            "statusbar_bluetooth_battery",
            "Bluetooth Battery",
    ...
    val qsPanelSettings = listOf(
        ...
        IconifySetting(
            ...
            "QS Columns (Landscape)",
            "Tiles per row in landscape",
            SettingType.SLIDER,
            true,
            xpReward = 15
        ),
    ...
    val lockscreenSettings = listOf(
        IconifySetting(
            ...
            "Clock Style",
            "12+ lock clock designs",
            SettingType.SELECTION,
            false,
            xpReward = 20
        ),
        IconifySetting(
            "lockscreen_clock_font_size",
            "Clock Font Size",
            "Adjust clock text size",
            SettingType.SLIDER,
            false,
            xpReward = 10
        ),
        ...
        IconifySetting(
            ...
            "Media Art Blur",
            "Blur level for album art",
            SettingType.SLIDER,
            false,
            xpReward = 15
        ),
        IconifySetting(
            "lockscreen_media_art_filter",
            "Media Art Filter",
            "Color filter on artwork",
            SettingType.SELECTION,
            false,
            xpReward = 15
        ),
        IconifySetting(
            "lockscreen_media_player_style",
            "Media Player Style",
            "12+ notification player styles",
            SettingType.SELECTION,
            false,
            xpReward = 25
        ),
        IconifySetting(
            ...
            "Fingerprint Icon Scale",
            "Resize fingerprint icon",
            SettingType.SLIDER,
            false,
            xpReward = 10
        ),
        IconifySetting(
            "lockscreen_fingerprint_transparency",
        ...
        IconifySetting(
            "lockscreen_double_tap_to_sleep",
            "Double Tap to Sleep",
            "Lock device on double tap",
            SettingType.TOGGLE,
            true,
            xpReward = 20
        ),
        IconifySetting(
            "lockscreen_carrier_text",
            "Carrier Text",
            "Show/hide carrier name",
            SettingType.TOGGLE,
            false,
            xpReward = 5
        ),
        ...
        IconifySetting(
            "lockscreen_charging_info_enabled",
            "Charging Info",
            "Show voltage/current/watts",
            SettingType.TOGGLE,
            false,
            xpReward = 15
        ),
        IconifySetting(
            "lockscreen_charging_info_text_size",
            "Charging Info Size",
        ...
        IconifySetting(
            "lockscreen_shortcut_left",
            "Left Shortcut",
            "Custom left quick action",
            SettingType.SELECTION,
            false,
            xpReward = 15
        ),
        IconifySetting(
            "lockscreen_shortcut_right",
            "Right Shortcut",
            "Custom right quick action",
            SettingType.SELECTION,
            false,
            xpReward = 15
        )
    ...
    val mediaPlayerSettings = listOf(
        IconifySetting(
            "media_player_style",
            "Player Style",
            "iOS 16, Android 13, Compact, etc",
            SettingType.SELECTION,
            false,
            xpReward = 25
        ),
        IconifySetting(
            "media_player_background_enabled",
            "Player Background",
        ...
        IconifySetting(
            "media_player_artwork_roundness",
            "Artwork Roundness",
        ...
        IconifySetting(
            "media_player_progress_bar_style",
            "Progress Bar Style",
            "Thin, thick, or iOS style",
            SettingType.SELECTION,
            false,
            xpReward = 15
        ),
        IconifySetting(
            "media_player_background_blur",
            "Background Blur",
            "Blur album art in background",
            SettingType.SLIDER,
            false,
            xpReward = 20
        ),
        IconifySetting(
            "media_player_seamless_enabled",
            "Seamless Player",
            "Hide player frame",
            SettingType.TOGGLE,
            false,
    ...
    val uiRoundnessSettings = listOf(
        ...
        IconifySetting(
            "ui_corner_radius_card",
            "Card Roundness",
            "Corner radius for UI cards",
            SettingType.SLIDER,
            true,
            xpReward = 10
        ),
        IconifySetting(
            "ui_corner_radius_button",
            "Button Roundness",
        ...
        IconifySetting(
            "ui_corner_radius_switch",
            "Switch Roundness",
            "Corner radius for toggles",
            SettingType.SLIDER,
            true,
            xpReward = 10
        ),
        IconifySetting(
            "ui_corner_radius_chip",
            "Chip Roundness",
            "Corner radius for chips",
            SettingType.SLIDER,
            true,
            xpReward = 10
        ),
        IconifySetting(
            "ui_corner_radius_bottom_sheet",
            "Bottom Sheet Roundness",
    ...
    val xposedFeatures = listOf(
        ...
        IconifySetting(
            "xposed_depth_wallpaper_enabled",
        ...
        IconifySetting(
            "xposed_notification_transparency",
        ...
        IconifySetting(
            "xposed_notification_background_color",
        ...
        IconifySetting(
            "xposed_wifi_battery_percentages",
    ...
    val iconShapeSettings = listOf(
        IconifySetting(
            "icon_shape_system",
            "System Icon Shape",
            "Circle, square, squircle, tear drop, hexagon, etc",
            SettingType.SELECTION,
            true,
            xpReward = 25
        ),
    ...
    val developerOptions = listOf(
        IconifySetting(
            "dev_restart_systemui",
            "Restart SystemUI",
            "Force restart UI process",
            SettingType.TOGGLE,
            true,
            xpReward = 10
        ),
        IconifySetting(
            "dev_clear_module_cache",
            "Clear Module Cache",
            "Reset all Iconify caches",
            SettingType.TOGGLE,
            false,
            xpReward = 5
        ),
        ...
        IconifySetting(
            "dev_force_rebuild_overlays",
            "Force Rebuild Overlays",
