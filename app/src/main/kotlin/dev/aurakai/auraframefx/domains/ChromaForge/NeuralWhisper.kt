...
import dev.aurakai.auraframefx.core.models.Emotion
...
class NeuralWhisper @Inject constructor(
    ...
    suspend fun speechToText(audioInput: Any? = null): String? =
        kotlinx.coroutines.suspendCancellableCoroutine { cont ->
            ...
            val intent = (audioInput as? android.content.Intent)
    ...
    fun textToSpeech(text: String, locale: Locale = Locale.US): Boolean {
        ...
        val result = tts?.speak(
            ...
            null,
            "AuraWhisper_" + System.currentTimeMillis()
        )
    ...
    // â”€â”€ Gemini Embedding 2: Direct Audio Ingestion â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    /**
     * ðŸŽ™ï¸ EMBED AUDIO DIRECT
     *
     * Ingests raw audio bytes directly into Gemini Embedding 2 â€” bypassing the
     ...
     *   - Cross-modal fusion (audio command + screen state â†’ single vector)
     *
    ...
    suspend fun embedAudioDirect(
        ...
        if (audioBytes.isEmpty()) {
            Log.w(TAG, "embedAudioDirect: empty audio bytes â€” skipping")
            return FloatArray(0)
        }
