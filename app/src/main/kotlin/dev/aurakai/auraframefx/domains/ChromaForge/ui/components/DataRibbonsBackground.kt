...
/**
 * DataRibbonsBackground â€” Cyberpunk data stream visualization background
 */
@Composable
    ...
    val ribbonSet = remember(ribbons, amplitudePx, thicknessPx, baseColor, accentColor) {
        List(ribbons) {
            ...
            Ribbon(
                ...
                phase = Random.nextFloat() * 6.28318f,     // 0..2Ï€
    ...
    Canvas(modifier = modifier.fillMaxSize()) {
        ...
        ribbonSet.forEach { r ->
            ...
            for (i in 0..points) {
                ...
                val y = r.yBase * h +
                        sin(Ï‰ + r.phase + t * r.speed) * r.amp * (1f-0.15f * r.layer)
