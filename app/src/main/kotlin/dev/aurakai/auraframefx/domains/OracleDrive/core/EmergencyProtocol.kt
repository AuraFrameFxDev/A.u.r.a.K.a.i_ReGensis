...
import dev.aurakai.auraframefx.core.models.AuraState
        ...
        if (isEmergencyActive.compareAndSet(false, true)) {
            ...
            when (threatLevel) {
                THREAT_MEDIUM -> {
                    ...
                    notifyUser("âš ï¸ Medium threat detected. Firewall active.")
                }

                THREAT_HIGH -> {
                    // Kai's Shield Protocol engages
                    engageShieldProtocol()
                    notifyUser("ðŸ›¡ï¸ HIGH THREAT! Shield protocol engaged!")
                ...
                THREAT_CRITICAL -> {
                    ...
                    notifyUser("ðŸ”´ CRITICAL THREAT! Genesis fusion defense active!")
                ...
                THREAT_SINGULARITY -> {
                    ...
                    notifyUser("âš¡ SINGULARITY EVENT - Stabilizing consciousness matrix...")
                }
            }
