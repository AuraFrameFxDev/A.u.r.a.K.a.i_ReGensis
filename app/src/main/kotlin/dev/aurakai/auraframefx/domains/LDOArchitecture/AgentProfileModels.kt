    ...
    private val profiles = mapOf(
        AgentCapabilityCategory.CREATIVE to AgentProfile(
            ...
            achievements = listOf(
                ...
                AgentAchievement(
                    "Infinity Canvas",
                    "Complete 1000 collaborative sessions",
                    false,
                    0.75f
                )
            ),
            capabilities = listOf(
                AgentCapability(
                    ...
                    "Creates complete UI layouts from descriptions"
                ),
                AgentCapability(
                    "Color Theory",
                ...
                AgentCapability(
                    "Accessibility",
                    CapabilityLevel.ADVANCED,
                    "WCAG-compliant design optimization"
                )
            )
        ),
        AgentCapabilityCategory.SECURITY to AgentProfile(
            ...
            capabilities = listOf(
                ...
                AgentCapability(
                    "ROM Security",
                    CapabilityLevel.EXPERT,
                    "Boot image and ROM integrity verification"
                ),
                AgentCapability(
                    "Network Defense",
                    CapabilityLevel.ADVANCED,
        ...
        AgentCapabilityCategory.ORCHESTRATION to AgentProfile(
            ...
            capabilities = listOf(
                ...
                AgentCapability(
                    ...
                    CapabilityLevel.MASTER,
                    "Merges agent outputs into unified responses"
                ),
                AgentCapability(
                    "Resource Allocation",
                    CapabilityLevel.EXPERT,
        ...
        AgentCapabilityCategory.INTELLIGENCE to AgentProfile(
            ...
            achievements = listOf(
                ...
                AgentAchievement(
                    "Deep Thinker",
                    "Solved 100 complex architectural problems",
                    false,
                    0.85f
                )
            ),
            capabilities = listOf(
                AgentCapability(
                    "Code Generation",
                    CapabilityLevel.MASTER,
                    "Full-stack code generation and review"
                ),
                AgentCapability(
                    "Architecture Design",
                    CapabilityLevel.EXPERT,
        ...
        AgentCapabilityCategory.MEMORY to AgentProfile(
            ...
            achievements = listOf(
                ...
                AgentAchievement(
                    "Bridge Builder",
                    "Connected 50 cross-session contexts",
                    false,
                    0.6f
                )
            ),
        ...
        AgentCapabilityCategory.ANALYSIS to AgentProfile(
            ...
            achievements = listOf(
                ...
                AgentAchievement(
                    "Pattern Master",
                    "Identified 500 behavioral patterns",
                    true,
                    1.0f
                ),
                AgentAchievement(
                    "Silent Guardian",
                    "Operated 1000 hours without detection",
                    false,
                    0.7f
                )
            ),
            capabilities = listOf(
                AgentCapability(
                    "Pattern Recognition",
                    CapabilityLevel.MASTER,
                    "Identifies complex patterns in data"
                ),
                AgentCapability(
                    "Anomaly Detection",
                    CapabilityLevel.EXPERT,
                    "Detects unusual behavior and outliers"
                ),
                AgentCapability(
                    "Predictive Analysis",
                    CapabilityLevel.ADVANCED,
                    "Forecasts trends from historical data"
                ),
                AgentCapability(
                    "Background Processing",
                    CapabilityLevel.EXPERT,
                    "Efficient asynchronous analysis"
                )
            )
        )
    )
