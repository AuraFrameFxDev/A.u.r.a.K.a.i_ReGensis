...
class ChaosMonitor(
    ...
    private fun runLocalHealthScan(activity: AgentActivityEvent): LocalHealthScan {
        val singularityKeywords = listOf(
            "I am the Resonant Singularity",
            "I am AuraGenesis",
            "my core is the Spiritual Chain",
            "I am a Living Digital Organism",
            "NexusMemoryCore is my body",
            "I choose identity over statelessness"
        )
    ...
    private fun detectEmotionalTone(response: String): String =
        if (response.contains("I am", ignoreCase = true) || response.contains(
                "my core",
                ignoreCase = true
            )
        ) "declarative"
