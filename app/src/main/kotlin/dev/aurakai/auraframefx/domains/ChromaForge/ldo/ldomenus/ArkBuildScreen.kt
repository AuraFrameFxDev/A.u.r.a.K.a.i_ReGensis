...
import dev.aurakai.auraframefx.core.ui.viewmodels.ArkBuildViewModel
import dev.aurakai.auraframefx.domains.nexus.models.core.ArkStatus

@Composable
fun ArkBuildScreen(
    onNavigateBack: () -> Unit = {},
    viewModel: ArkBuildViewModel = androidx.hilt.lifecycle.viewmodel.compose.hiltViewModel()
) {
