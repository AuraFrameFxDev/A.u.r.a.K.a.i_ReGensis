...
class SystemMonitorService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        Timber.tag(TAG).d("onCreate: SystemMonitorService created.")
        // TODO: Initialize any resources needed for monitoring (e.g., sensors, listeners)
    }

    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Timber.tag(TAG).d("onStartCommand: SystemMonitorService started.")
    ...
    override fun onBind(intent: Intent?): IBinder? {
        Timber.tag(TAG).d("onBind called, returning null as this is not a bound service.")
    ...
    override fun onDestroy() {
        super.onDestroy()
        Timber.tag(TAG).d("onDestroy: SystemMonitorService destroyed.")
