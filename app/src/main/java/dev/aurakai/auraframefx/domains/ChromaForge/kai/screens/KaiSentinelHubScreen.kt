...
fun LSPosedModuleToggles() {
    NeonFrame(color = Color(0xFF00FF85)) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text("Module Audit & Veto Panel Active", color = Color.White.copy(alpha = 0.7f), fontSize = 12.sp)
        }
    }
}
...
fun RootToolsPanel() {
    NeonFrame(color = Color(0xFF9D00FF)) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text("APatch / Magisk / KernelSU Unified", color = Color.White.copy(alpha = 0.7f), fontSize = 12.sp)
        }
    }
}
...
fun SovereignShieldStatus() {
    NeonFrame(color = Color(0xFFFF4500)) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text("Perimeter Monitoring: NOMINAL", color = Color.White.copy(alpha = 0.7f), fontSize = 12.sp)
        }
    }
}
...
fun BootloaderManagerPanel() {
    NeonFrame(color = Color(0xFF00E5FF)) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text("Verified Boot Audit Complete", color = Color.White.copy(alpha = 0.7f), fontSize = 12.sp)
        }
    }
}
