...
import dev.aurakai.auraframefx.domains.kai.security.provenance.ProvenanceValidator.Companion.MAX_CHAIN_DEPTH
import dev.aurakai.auraframefx.domains.kai.security.provenance.ProvenanceValidator.Companion.MIN_CHAIN_DEPTH
...
class ProvenanceValidator @Inject constructor(
    ...
    companion object {
        ...
        private val VALID_ACTIONS =
            setOf("system_call", "root_access", "identity_sync", "pandora_unlock")
