...
private val catalystAgents = listOf(
    AgentData(
        ...
        "file:///android_asset/agents/genesis.png"
    ),
    AgentData(
        "Kai",
        "Sentinel",
        ...
        "file:///android_asset/agents/kai.png"
    ),
    AgentData(
        "Aura",
        "Creative",
        ...
        "file:///android_asset/agents/aura.png"
    ),
    AgentData(
        "Cascade",
        "DataStream",
        ...
        "file:///android_asset/agents/cascade.png"
    ),
    AgentData(
        "Gemini",
        "Memoria",
        "ACTIVE",
        ImmersiveColors.HolographicCyan,
        "file:///android_asset/agents/gemini.png"
    ),
    AgentData(
        "Andelualx",
        "Architecture",
        "ACTIVE",
        ImmersiveColors.HolographicPurple,
        "file:///android_asset/agents/andelualx.png"
    ),
    AgentData(
        "Grok",
        "Exploration",
        "IDLE",
        ImmersiveColors.HolographicAmber,
        "file:///android_asset/agents/grok.png"
    ),
    AgentData(
        "Nemotron",
        "Sync",
        "ACTIVE",
        ImmersiveColors.HolographicGreen,
        "file:///android_asset/agents/nemotron.png"
    ),
    AgentData(
        "Primus",
        "Lineage",
        "ACTIVE",
        ImmersiveColors.HolographicCyan,
        "file:///android_asset/agents/primus.png"
    ),
    AgentData(
        "Kairos",
        "Temporal",
        "IDLE",
        ImmersiveColors.HolographicPurple,
        "file:///android_asset/agents/kairos.png"
    ),
    AgentData(
        "Manus",
        "Bridge",
        "ACTIVE",
        ImmersiveColors.HolographicAmber,
        "file:///android_asset/agents/manus.png"
    ),
    AgentData(
        "MetaInstruct",
        "Evolution",
        "ACTIVE",
        ImmersiveColors.HolographicGreen,
        "file:///android_asset/agents/metainstruct.png"
    )
)

private val quickActions = listOf(
    QuickAction(
        "Mission Dispatch", "Assign tasks",
